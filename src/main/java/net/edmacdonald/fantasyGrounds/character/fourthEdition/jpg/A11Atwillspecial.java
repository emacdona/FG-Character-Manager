...
import net.edmacdonald.fantasyGrounds.character.fourthEdition.jpg.Power;
import net.edmacdonald.fantasyGrounds.character.fourthEdition.jpg.Usesavailable;
...
@XmlRootElement(name = "a11-atwillspecial")
public class A11Atwillspecial {
